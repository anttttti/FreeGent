...
const MODEL_CATALOG = [
    ...
    { provider:'kilo', model:'nvidia/nemotron-3-ultra-550b-a55b:free',         label:'Nemotron 3 Ultra 550B (free)',     released:'2025-08', contextK:1000, params:550, media:['text'],        tools:true, thinking:true,  note:'550B MoE (45B active); 1M ctx; deep reasoning; free via Kilo' },
    { provider:'kilo', model:'nvidia/nemotron-3-super-120b-a12b:free',          label:'Nemotron 3 Super 120B (free)',     released:'2025-08', contextK:262,  params:120, media:['text'],        tools:true, thinking:true,  note:'120B MoE (12B active); 262K ctx; free via Kilo' },
    { provider:'kilo', model:'nvidia/nemotron-3.5-lightning:free',              label:'Nemotron 3.5 Lightning (free)',    released:'2026-07', contextK:1000, params:30,  media:['text'],        tools:true, thinking:false, note:'30B MoE (3B active); 1M ctx; fast; free via Kilo' },
    { provider:'kilo', model:'nvidia/nemotron-3-nano-omni-30b-a3b-reasoning:free', label:'Nemotron 3 Nano Omni 30B (free)', released:'2026-06', contextK:256, params:30, media:['text','image'], tools:true, thinking:true,  note:'30B MoE (3B active); 256K ctx; omni reasoning; free via Kilo' },
    { provider:'kilo', model:'stepfun/step-3.7-flash:free',                     label:'Step 3.7 Flash (free)',            released:'2026-07', contextK:262,  params:198, media:['text'],        tools:true, thinking:true,  note:'198B MoE (11B active); 262K ctx; fast reasoning; free via Kilo' },
    { provider:'kilo', model:'poolside/laguna-s-2.1:free',                      label:'Laguna S 2.1 (free)',              released:'2026-09', contextK:262,  params:118, media:['text'],        tools:true, thinking:true,  note:'118B MoE (8B active); 262K ctx; coding agent; free via Kilo' },
    { provider:'kilo', model:'poolside/laguna-xs-2.1:free',                     label:'Laguna XS 2.1 (free)',             released:'2026-09', contextK:262,  params:33,  media:['text'],        tools:true, thinking:true,  note:'33B MoE (3B active); 262K ctx; fast coding agent; free via Kilo' },
    { provider:'kilo', model:'thinkingmachines/inkling:free',                   label:'Inkling (free)',                   released:'2026-09', contextK:1000, params:975, media:['text'],        tools:true, thinking:true,  note:'975B MoE (41B active); 1M ctx; reasoning model; free via Kilo' },
    { provider:'kilo', model:'thinkingmachines/inkling-small:free',             label:'Inkling Small (free)',             released:'2026-09', contextK:1000, params:276, media:['text'],        tools:true, thinking:true,  note:'276B MoE (12B active); 1M ctx; small fast reasoning model; free via Kilo' },
    { provider:'kilo', model:'dots-studio/dots-3-note-preview:free',            label:'Dots 3 Note (free)',               released:'2026-08', contextK:512,  params:280, media:['text'],        tools:true, thinking:false, note:'280B MoE (16B active); 512K ctx; long-context; free via Kilo' },
    { provider:'kilo', model:'cohere/north-mini-code:free',                     label:'North Mini Code (free)',           released:'2026-08', contextK:256,  params:30,  media:['text'],        tools:true, thinking:false, note:'30B MoE (3B active); 256K ctx; code-focused; free via Kilo' },
